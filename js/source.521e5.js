...
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_hot_loader__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_Scheduler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(14);
var _dec, _class;
...
class helpers_BaseTaskModel {
  constructor(id = Object(uuid["v4"])(), completed = false, favorite = false, message = 'Выполнить важную задачу (создано в конструкторе).', created = moment_default()()) {
    this.id = id;
...
class Task_Task extends react["PureComponent"] {
  constructor(...args) {
    ...
    this._setTaskEditingState = editState => {
      if (editState) {
        this.setState({
          isTaskEditing: true
...
var Spinner_styles_m = __webpack_require__(12);
...
var Scheduler_styles_m = __webpack_require__(4);
...
const api = {
  ...
  completeAllTasks: async oldTasks => {
    ...
    const tasks = await Promise.all(requests).then(responses => Promise.all(responses.map(r => r.json()))).then(result => result.map(r => r.data).reduce((a1, a2) => [...a1, ...a2]));
    return tasks;
  }
};
  ...
  constructor(...args) {
    ...
    this._updateTaskAsync = async task => {
      ...
      this.setState(({
        ...
        const updatedTaskList = tasks.map(currTask => updatedTask.find(updTask => updTask.id === currTask.id) || currTask);
        return {
          newTaskMessage: '',
      ...
      if (!this._getAllCompleted()) {
        ...
        if (uncompletedTasks.length) {
          ...
          try {
            ...
            if (!updatedTasks || updatedTasks.length !== uncompletedTasks.length) {
              throw error;
            }
          }

          const updatedTaskList = tasks.map(currTask => updatedTasks.find(updTask => updTask.id === currTask.id) || currTask);
          this.setState({
            tasks: sortTasksByGroup(updatedTaskList)
          });
...
/* harmony import */ var _theme_init__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21);
...
/* harmony import */ var _pages_App__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(11);
// Core
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.521e5.js.map